...
.f{
    ...
    <li>
       <form  action="home.php">
      <button class="b" style="color:white" ><h2> DESIGN</h2></button></form>
    </li>
    <li>
       <form  action="home.php">
